...
print("The first three guests on the list are, :")#print message
for guest in guests[:3]:#guests 0-2
    print(guest.title())#capital names

print("The guests in the middle of the lists are,:")#print message
for guest in guests[1:4]:#guests
    print(guest.title())#capital names

print("The last three guests on the list are, :")#print message
for guest in guests[3:]:#guests
    print(guest.title())#capital names
